...
export const BentoGridItem = ({
    ...
    const rightLists = ["Node.js", "Tailwind", "GraphQL"];
    ...
    const handleCopy = () => {
        const text = "gashimovilya2018@gmail.com";
            ...
            <div className={`${id === 6 && "flex justify-center"} h-full`}>
                ...
                {id === 6 && (
                    <BackgroundGradientAnimation>
                        ...
                        pointer-events-none text-3xl text-center md:text-4xl lg:text-7xl"></div>
                    </BackgroundGradientAnimation>
                )}
                ...
                <div
                    className={cn(
                        titleClassName,
                        "group-hover/bento:translate-x-2 transition duration-200 relative md:h-full min-h-40 flex " +
                        "flex-col px-5 p-5 lg:p-10"
                    )}
                >

                    <div className="font-sans font-extralight md:max-w-32 md:text-xs lg:text-base text-sm
                                    text-[#C1C2D3] z-10">
                        {description}
                    </div>
